...
class Application
{
     ...
     */
    public static function create(string $key, ?RequestMock $requestMock = null, bool $devMode = false, bool $testMode = false): self
    {
        if (!array_key_exists($key, self::$instances)) {
            ...
            if($devMode)  ApplicationController::create()->setDevMode();
            if($testMode) ApplicationController::create()->setTestMode();
        }
